...
const seedFuelReports = [
  ...
  {"id":"f-27","tailNumber":"N464ER","date":"2025-11-04","issue":"Delayed","waitingMinutes":"","fuelLevel":"","notes":"Aircraft was fueled despite an active no-fuel order."},
  {"id":"f-28","tailNumber":"N464ER","date":"2025-11-05","issue":"Delayed","waitingMinutes":"","fuelLevel":"","notes":"Aircraft was fueled again despite an active no-fuel order."},
  ...
  {"id":"f-37","tailNumber":"N52522","date":"2025-11-21","issue":"Delayed","waitingMinutes":"","fuelLevel":"","notes":"Called 12:18 for tabs, 12:36 student and instructor cancelled due to no truck in sight | 12:37"},
  ...
  {"id":"f-60","tailNumber":"N24108","date":"2026-03-11","issue":"Incorrect fuel level","waitingMinutes":"","fuelLevel":51,"notes":"Called for Tabs and they filled it all the way up, Crew was unable to fly that aircraft due to the weight of the fuel."},
  ...
  {"id":"f-63","tailNumber":"N55297","date":"2026-03-26","issue":"Delayed","waitingMinutes":50,"fuelLevel":28,"notes":"Called 11:20AM for tabs, no fuel truck, called again at 11:58 and still hadn't fueled by 12:15"},
  ...
  {"id":"f-78","tailNumber":"N464ER","date":"2026-04-14","issue":"Delayed","waitingMinutes":40,"fuelLevel":15,"notes":"Lesson cancelled Called for override for no fuel order, they never came. Crew moved the lesson to a ground session. I called Atlantic to ensure that they do not fuel the aircraft until tomorrow due to Spin Training."},
  {"id":"f-79","tailNumber":"N464ER","date":"2026-04-15","issue":"Delayed","waitingMinutes":40,"fuelLevel":20,"notes":"Dispatcher called at 11:35 AM for fuel and to lift no fuel order, dispatcher called again at 12:11 PM to get fuel. Progress check waiting fuel. Lesson cancelled"},
  {"id":"f-80","tailNumber":"N24108","date":"2026-04-16","issue":"Delayed","waitingMinutes":120,"fuelLevel":20,"notes":"Dispatcher called for fuel 9:55AM and again at 10:40 and then again at 11:45 fueling was not completed until 12PM. Led to lesson cancellation."},
  ...
  {"id":"f-90","tailNumber":"N174TH","date":"2026-04-20","issue":"Other","waitingMinutes":"","fuelLevel":44,"notes":"Dispatcher walked the fleet due to no one flying anymore in the evening at 6:50 PM to call for fuel, at 8 20 when I walked again they were fueled but approximately 22-23 gallons each tank..."},
  {"id":"f-91","tailNumber":"N24108","date":"2026-04-21","issue":"Other","waitingMinutes":"","fuelLevel":48,"notes":"Dispatcher walked the fleet due to no one flying anymore in the evening at 6:50 PM to call for fuel, at 8 20 when I walked again they were fueled but approximately 22-23 gallons each tank..."},
  {"id":"f-92","tailNumber":"N55297","date":"2026-04-22","issue":"Other","waitingMinutes":"","fuelLevel":47,"notes":"Dispatcher walked the fleet due to no one flying anymore in the evening at 6:50 PM to call for fuel, at 8 20 when I walked again they were fueled but approximately 22-23 gallons each tank..."},
  ...
  {"id":"f-97","tailNumber":"N174TH","date":"2026-05-01","issue":"Other","waitingMinutes":"","fuelLevel":30,"notes":"Called last night for top offs (per dispatch) but no top off following morning when checked at 7:40AM."},
  {"id":"f-98","tailNumber":"N6064R","date":"2026-05-01","issue":"Other","waitingMinutes":"","fuelLevel":30,"notes":"Called last night for top offs (per dispatch) but no top off following morning when checked at 7:40AM."},
  ...
  {"id":"f-102","tailNumber":"N464ER","date":"2026-05-15","issue":"Delayed","waitingMinutes":"","fuelLevel":30,"notes":"Called 7:49am to put 7gal in each wing, 8:18am student and instructor had to move planes because hadn't been fueled"},
...
async function saveFuelReports(options = {}) {
  cacheLocalData(FUEL_STORAGE_KEY, fuelReports);
  fuelReports = await saveCollectionData("fuel-discrepancies", fuelReports, options);
  cacheLocalData(FUEL_STORAGE_KEY, fuelReports);
}
...
rows.addEventListener("click", (event) => {
  ...
  saveFuelReports({ allowDeletes: true });
  renderFilters();
  render();
});
